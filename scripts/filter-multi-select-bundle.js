...
function addPlaceholder(wrapper) {
    ...
    if (!tokens.length && !(document.activeElement === input_search))
        input_search.setAttribute("placeholder", "Search for keywords");
}
...
function populateAutocompleteList(select, query, dropdown = false) {
    ...
    if (result_size == 1) {
        ...
        li.setAttribute('class', 'autocomplete-list_li');
...
function selectOption(e) {
    ...
    const input_search = wrapper.querySelector(".selected-input");
    const li_item = wrapper.querySelector(".autocomplete-list_li");
    const list = wrapper.querySelector(".search-container");
...
//    const li_item = wrapper.querySelector(".autocomplete-list_li");
//    const list = wrapper.querySelector(".search-container");
//     option_to_unselect.classList.remove('active')
//    list.classList.toggle('active')
   

//   option_to_unselect.removeAttribute("disabled", "");
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    const select = document.querySelectorAll(".first");
